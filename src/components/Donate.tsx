...
function Donate() {
    return (
        <div id="donate" className="relative bg-[url('/background.webp')] h-screen mx-auto bg-[#F0F2F5] dark:bg-[#202C33] flex flex-col justify-center items-center gap-8 py-20">
